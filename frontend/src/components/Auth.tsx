        ...
        try {
            ...
            if (axios.isAxiosError(e)) {
                ...
                if (axiosError.response) {
                    ...
                    let message = ""
                    if (status == 411) {
                        message = "password min of 6 char"
                    }
                    else if (status == 403) {
                        message = "No user with these cred"
                    }
                    else {
        ...
        return (
            ...
            <label className="block mb-4">
                ...
                <div className="relative block mb-4">
                    ...
                    <input name="password" className="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-red-500 focus:ring-red-500 block w-full rounded-md sm:text-sm focus:ring-1"
